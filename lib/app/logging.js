var logging = {
    initRequestLogger: function (reqUrl, reqObj, respObj, method, accessTime) {
        ...
        respObj.res.addListener('finish', function () {
            var id = respObj._weppId
                , stat = respObj.res.statusCode
            ...
            try {
                wepp.log[level](logMsg);
            }
            catch (e) {
                wepp.log.error('Logging failed for request, id ' + id);
            }
        });
    }
